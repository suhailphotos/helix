# ------------------------------------------------------------------------------
# Save shell options to restore later and normalize parsing behavior
# ------------------------------------------------------------------------------
...
() {
  # ---------------------------------------------------------------------------
  # Initialize Powerlevel10k environment
  # ---------------------------------------------------------------------------
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION="${PROMPT_SYMBOL}"
